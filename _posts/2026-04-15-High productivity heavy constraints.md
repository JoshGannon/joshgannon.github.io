...
Due to vendor hardware upgrades and thousands of firewalls needing this replacement of critical infrastructure, I was tasked with creating a technical, semi-automated build system across multiple teams to meet the deadline.
...
Again worked with the Development team, this time to define regular expression matching (this was just before AI was being leveraged). Mostly this was fancy 'find and replace'. These manipulations were then ready to be pushed against the new boxes  .
...
At that point, it was necessary to train the team applying these configurations and getting the boxes out the door. Logistically, this meant that a team of more than a handful needed new documentation and training to scale up the build process by at least 300% - they almost doubled that. A new mindset was presented and adopted, and the team got to work. After a few builds, we saw the productivity gains increase rapidly and projections for the deadline were soon well within reach.
